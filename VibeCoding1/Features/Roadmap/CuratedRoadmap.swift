...
enum CuratedRoadmap {
    ...
    static let all: [CuratedBook] = [
        ...
        // Aristotle
        // ---------------------
            .init(philosopher: .aristotle, step: 1, title: "니코마코스 윤리학", author: "아리스토텔레스", role: "입문",
                  reason: "덕·행복·습관 개념으로 아리스토텔레스의 사고방식을 가장 직관적으로 익힘.",
                  altTitles: ["윤리학", "Nicomachean Ethics", "니코마코스윤리학"]),
        .init(philosopher: .aristotle, step: 1, title: "정치학", author: "아리스토텔레스", role: "입문",
              reason: "윤리학과 이어지는 ‘좋은 삶/좋은 공동체’ 논의를 통해 전체 그림을 잡기 좋음.",
              altTitles: ["Politics", "아리스토텔레스 정치학"]),
        .init(philosopher: .aristotle, step: 1, title: "시학", author: "아리스토텔레스", role: "입문",
              reason: "짧지만 강력한 텍스트. 개념 정의 방식(원인/구조)을 맛보기로 좋음.",
              altTitles: ["Poetics", "아리스토텔레스 시학"]),
        .init(philosopher: .aristotle, step: 2, title: "범주론", author: "아리스토텔레스", role: "핵심",
              reason: "논리학 입문. ‘개념을 분류하는 방식’이 이후 텍스트 전반의 문법이 됨.",
              altTitles: ["Categories", "범주론/해석에 대하여"]),
        .init(philosopher: .aristotle, step: 2, title: "해석에 대하여", author: "아리스토텔레스", role: "핵심",
              reason: "명제·부정·필연 등 논리적 구조를 다룸. 오르가논의 대표 관문.",
              altTitles: ["On Interpretation", "De Interpretatione"]),
        .init(philosopher: .aristotle, step: 3, title: "형이상학", author: "아리스토텔레스", role: "심화",
              reason: "‘존재를 존재로서’ 탐구. 가장 핵심이면서도 난해한 본령.",
              altTitles: ["Metaphysics", "아리스토텔레스 형이상학"]),
        .init(philosopher: .aristotle, step: 3, title: "자연학", author: "아리스토텔레스", role: "심화",
              reason: "변화·운동·원인을 통해 자연 세계의 철학적 설명을 제공.",
              altTitles: ["Physics", "아리스토텔레스 자연학"]),
        .init(philosopher: .aristotle, step: 3, title: "영혼에 대하여", author: "아리스토텔레스", role: "심화",
        ...
        // Augustine
        // ---------------------
            .init(philosopher: .augustine, step: 1, title: "고백록", author: "아우구스티누스", role: "입문",
                  reason: "내면 성찰과 회심의 서사로 중세 철학의 출발 감각을 가장 잘 익힘.",
                  altTitles: ["Confessions", "아우구스티누스 고백록"]),
        .init(philosopher: .augustine, step: 1, title: "교사론", author: "아우구스티누스", role: "입문",
              reason: "언어/기억/가르침을 통해 인식론적 핵심 문제로 자연스럽게 진입.",
              altTitles: ["De Magistro", "On the Teacher"]),
        .init(philosopher: .augustine, step: 2, title: "신국론", author: "아우구스티누스", role: "핵심",
              reason: "역사·정치·신학이 엮인 거대 텍스트. 중세 사유의 틀을 잡는 핵심.",
              altTitles: ["City of God", "De Civitate Dei"]),
        .init(philosopher: .augustine, step: 2, title: "자유의지론", author: "아우구스티누스", role: "핵심",
              reason: "악과 자유의지 문제를 체계적으로 다룸. 이후 스콜라 논쟁의 출발점.",
              altTitles: ["On Free Choice of the Will", "De libero arbitrio"]),
        .init(philosopher: .augustine, step: 3, title: "삼위일체론", author: "아우구스티누스", role: "심화",
        ...
        // Anselm
        // ---------------------
            .init(philosopher: .anselm, step: 1, title: "프로슬로기온", author: "안셀무스", role: "입문",
                  reason: "존재론적 논증의 핵심 텍스트. 중세 논증 스타일을 짧게 체험.",
                  altTitles: ["Proslogion", "프로슬로기온/모놀로기온"]),
        .init(philosopher: .anselm, step: 1, title: "모놀로기온", author: "안셀무스", role: "입문",
              reason: "하나의 원리로 신을 사유하려는 시도. 논증 흐름 연습에 좋음.",
              altTitles: ["Monologion"]),
        .init(philosopher: .anselm, step: 2, title: "왜 신이 인간이 되었는가", author: "안셀무스", role: "핵심",
              reason: "속죄/구원 논의의 고전. 신학이 철학적 논증으로 전개되는 방식을 보여줌.",
              altTitles: ["Cur Deus Homo", "왜 신이 사람이 되었는가"]),
        .init(philosopher: .anselm, step: 3, title: "안셀무스 선집", author: "안셀무스", role: "심화",
        ...
        .init(philosopher: .boethius, step: 2, title: "신학 소논문집", author: "보에티우스", role: "핵심",
        ...
        // Avicenna (Ibn Sina)
        // ---------------------
            .init(philosopher: .avicenna, step: 1, title: "아비센나 입문", author: "이븐 시나(아비센나)", role: "입문",
                  reason: "이슬람 철학의 큰 지도를 먼저 잡고, 존재론 핵심 개념으로 들어가기 위한 진입로.",
                  altTitles: ["Avicenna introduction", "이븐 시나 입문", "아비센나"]),
        .init(philosopher: .avicenna, step: 2, title: "치유의 서(형이상학)", author: "이븐 시나(아비센나)", role: "핵심",
        ...
        // Averroes (Ibn Rushd)
        // ---------------------
            .init(philosopher: .averroes, step: 1, title: "아베로에스 입문", author: "이븐 루시드(아베로에스)", role: "입문",
                  reason: "아리스토텔레스 해석 전통을 이해하기 위한 진입. ‘이성’의 위상을 둘러싼 논쟁의 중심.",
                  altTitles: ["Averroes introduction", "이븐 루시드 입문", "아베로에스"]),
        .init(philosopher: .averroes, step: 2, title: "아리스토텔레스 주석(선집)", author: "이븐 루시드(아베로에스)", role: "핵심",
        ...
        // Duns Scotus
        // ---------------------
            .init(philosopher: .dunsScotus, step: 1, title: "둔스 스코투스 입문", author: "둔스 스코투스", role: "입문",
                  reason: "스콜라 후반의 논점(개별성/형이상학)을 이해하기 위한 지도 확보.",
                  altTitles: ["Duns Scotus introduction", "스코투스 입문", "Scotus"]),
        .init(philosopher: .dunsScotus, step: 2, title: "형이상학에 관한 강해(선집)", author: "둔스 스코투스", role: "핵심",
        ...
        // Ockham
        // ---------------------
            .init(philosopher: .ockham, step: 1, title: "오컴 입문", author: "오컴", role: "입문",
                  reason: "명목론과 방법론적 전환을 이해하기 위한 출발점.",
                  altTitles: ["Ockham introduction", "오컴의 면도날", "Ockham"]),
        .init(philosopher: .ockham, step: 2, title: "오컴 논리학(선집)", author: "오컴", role: "핵심",
        ...
        // Spinoza
        // ---------------------
            .init(philosopher: .spinoza, step: 1, title: "스피노자 입문", author: "스피노자", role: "입문",
                  reason: "일원론·실체 개념과 기하학적 전개 방식을 읽기 전에 지도부터 확보.",
                  altTitles: ["Spinoza introduction", "스피노자 가이드", "스피노자"]),
        .init(philosopher: .spinoza, step: 2, title: "윤리학", author: "스피노자", role: "핵심",
              reason: "기하학적 방법으로 실체·정서·자유를 전개하는 대표 저작(난도 높음).",
              altTitles: ["Ethics", "Ethica", "스피노자 윤리학"]),
        .init(philosopher: .spinoza, step: 3, title: "신학정치론", author: "스피노자", role: "심화",
        ...
        // Locke
        // ---------------------
            .init(philosopher: .locke, step: 1, title: "로크 입문", author: "로크", role: "입문",
        ...
        .init(philosopher: .locke, step: 3, title: "정부론(통치론)", author: "로크", role: "심화",
        ...
        // Leibniz
        // ---------------------
            .init(philosopher: .leibniz, step: 1, title: "라이프니츠 입문", author: "라이프니츠", role: "입문",
                  reason: "단자론·합리론·형이상학 논점(실체/가능세계)을 읽기 전 지도 확보.",
                  altTitles: ["Leibniz introduction", "라이프니츠 가이드", "라이프니츠"]),
        .init(philosopher: .leibniz, step: 2, title: "단자론", author: "라이프니츠", role: "핵심",
              reason: "라이프니츠 형이상학의 핵심(단자·조화·표상)을 가장 압축적으로 제시하는 텍스트.",
              altTitles: ["Monadology", "모나돌로지", "단자론/형이상학 서설"]),
        .init(philosopher: .leibniz, step: 3, title: "신정론", author: "라이프니츠", role: "심화",
        ...
        // Nietzsche
        // ---------------------
            .init(philosopher: .nietzsche, step: 1, title: "니체 입문", author: "니체", role: "입문",
                  reason: "힘/가치/도덕 비판의 핵심 문제의식을 먼저 정리하면 원전이 훨씬 선명해짐.",
                  altTitles: ["Nietzsche introduction", "니체 가이드", "니체"]),
        .init(philosopher: .nietzsche, step: 2, title: "선악의 저편", author: "니체", role: "핵심",
              reason: "도덕·진리·철학 자체를 겨냥한 비판이 압축적으로 전개되는 핵심 텍스트.",
              altTitles: ["Beyond Good and Evil", "BGE", "선악의 저편/도덕의 계보"]),
        .init(philosopher: .nietzsche, step: 3, title: "도덕의 계보", author: "니체", role: "심화",
        ...
        // Kierkegaard
        // ---------------------
            .init(philosopher: .kierkegaard, step: 1, title: "키르케고르 입문", author: "키르케고르", role: "입문",
                  reason: "실존·불안·신앙의 핵심 테마와 문체를 먼저 이해하면 원전 난도가 크게 내려감.",
                  altTitles: ["Kierkegaard introduction", "키르케고르 가이드", "키르케고르"]),
        .init(philosopher: .kierkegaard, step: 2, title: "불안의 개념", author: "키르케고르", role: "핵심",
              reason: "불안·자유·가능성 개념을 통해 실존철학의 문제 구도를 가장 잘 잡아줌.",
              altTitles: ["The Concept of Anxiety", "불안 개념", "불안의 개념(개정)"]),
        .init(philosopher: .kierkegaard, step: 3, title: "죽음에 이르는 병", author: "키르케고르", role: "심화",
        ...
        // ---------------------
            .init(philosopher: .hume, step: 1, title: "흄 입문", author: "흄", role: "입문",
                  reason: "인과·자아·귀납 문제로 이어지는 핵심 논점을 먼저 정리.",
                  altTitles: ["Hume introduction", "흄 가이드", "흄"]),
        .init(philosopher: .hume, step: 2, title: "인간 본성에 관한 논고", author: "흄", role: "핵심",
              reason: "흄 경험론의 정점. 길고 난해하지만 전체 체계를 가장 직접적으로 제시.",
              altTitles: ["A Treatise of Human Nature", "Treatise", "인성론"]),
        .init(philosopher: .hume, step: 3, title: "인간 지성에 관한 탐구", author: "흄", role: "심화",
        ...
        // ---------------------
            .init(philosopher: .rousseau, step: 1, title: "루소 입문", author: "루소", role: "입문",
                  reason: "근대 정치철학의 문제의식(자연상태/시민/불평등)을 지도부터 잡기.",
                  altTitles: ["Rousseau introduction", "루소 가이드", "루소"]),
        .init(philosopher: .rousseau, step: 2, title: "사회계약론", author: "루소", role: "핵심",
              reason: "정치적 정당성의 근거를 ‘일반의지’로 세우는 대표 저작.",
              altTitles: ["The Social Contract", "Social Contract", "사회 계약론"]),
        .init(philosopher: .rousseau, step: 3, title: "에밀", author: "루소", role: "심화",
        ...
        // Kant (18th century)
        // ---------------------
            .init(philosopher: .kant, step: 1, title: "칸트 입문", author: "칸트", role: "입문",
                  reason: "비판철학의 용어(선험, 범주, 현상/물자체)를 먼저 정리.",
                  altTitles: ["Kant introduction", "칸트 가이드", "칸트"]),
        .init(philosopher: .kant, step: 2, title: "순수이성비판", author: "칸트", role: "핵심",
              reason: "근대 인식론의 전환점. 난도 높으므로 해설/강의와 병행 추천.",
              altTitles: ["Critique of Pure Reason", "CPR", "순수 이성 비판"]),
        .init(philosopher: .kant, step: 3, title: "실천이성비판", author: "칸트", role: "심화",
        ...
        // Marx (19th century)
        // ---------------------
            .init(philosopher: .marx, step: 1, title: "마르크스 입문", author: "마르크스", role: "입문",
                  reason: "역사유물론·자본주의 분석의 문제의식을 먼저 잡고 들어가기 위한 지침서.",
                  altTitles: ["Marx introduction", "마르크스 가이드", "마르크스"]),
        .init(philosopher: .marx, step: 2, title: "공산당 선언", author: "마르크스", role: "핵심",
              reason: "짧지만 핵심이 집약된 정치적 텍스트. 이후 저작들의 문제의식을 선명히 함.",
              altTitles: ["Communist Manifesto", "Manifesto", "공산당 선언문"]),
        .init(philosopher: .marx, step: 3, title: "자본", author: "마르크스", role: "심화",
